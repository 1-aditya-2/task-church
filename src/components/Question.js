...
let customQuestions = [
    { 
        Statement: "Our church's ministry strategy is firm but flexible to accommodate unexpected game changers such as AI.", 
        num: 1 
    },
    {
    ...
    {
        Statement:"Our leadership team understands the value of tapping experts to educate our staff about AI.",
        num: 3,
    },
    {
        Statement:"Our church should have an AI policy that guides staff on tools, training, attribution, ethical boundaries, etc.",
        num:4,
    },
];
            ...
            <div className="QuestionnaireContainer">
                ...
                <div className="SliderWrapper">
                    ...
                    <datalist id="sliderOptions">
                        <option value="0" label="Strongly">a</option>
                        <option value="25" label="Disagree">b</option>
                        <option value="50" label="Neutral"></option>
                        <option value="75" label="Agree"></option>
                        <option value="100" label="Strongly"></option>
                    </datalist>
                </div>
